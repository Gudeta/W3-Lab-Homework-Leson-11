...
//private String name;
////--------------------------------------------------------------
//public PersonItem(int mail_id, String name)          // constructor
//   { mail_id = mail_id;
//     name = name;
//   }
////--------------------------------------------------------------
...
////private PersonItem nonMail;        // for deleted items
////-------------------------------------------------------------
//public HashTable(String size)       // constructor
//   {
//   arraySize = size;
